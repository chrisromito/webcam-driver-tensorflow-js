...
export type IPhaserFields = Record<string, any> & {
    aspect?: number | null
}
...
export class Phaser3D extends Phaser.Events.EventEmitter {
    scene: Scene
    root: GameScene
    view: Phaser.GameObjects.Extern
    ...
    constructor(phaserScene: GameScene, { fov = 75, aspect = null, near = 0.1, far = 1000, x = 0, y = 0, z = 0, anisotropy = 1, antialias = false }: IPhaserFields = {}) {
        super()
